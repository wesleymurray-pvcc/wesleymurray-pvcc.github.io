# Name: Wesley Murray
# Program Purpose: This program creates a program report
...
def perform_calculations():
    ...
    #Students: calculate other deductions here:
        ...
        net = pay - fed - state #be sure to subtract other deuctions here

    #add to totals

        total_gross += pay
        total_net += net
#append amts to lists
